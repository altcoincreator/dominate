 ...
 * The dominate Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("dominate") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    setWindowIcon(QIcon(":icons/dominate"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a dominate address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/dominate"), tr("&About dominate"), this);
    aboutAction->setToolTip(tr("Show information about dominate"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for dominate"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/dominate"), tr("Show/Hide &dominate"), this);
    toggleHideAction->setToolTip(tr("Show or hide the dominate window"));
    ...
    editConfigAction->setToolTip(tr("Edit the dominate.conf file in the default text editor"));
...
#ifndef Q_OS_MAC
            setWindowIcon(QIcon(":icons/dominate_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/dominate_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("dominate client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide dominate"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to dominate network", "", count));
}
