...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "dominate " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are dominate dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.dominate.com", "dnsseed.dominate.com"},
    {"dnsseed.dominatefoundation.org", "dnsseed.dominatefoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.dominate.com", "tseed.dominate.com"},
    {"testnet-seed.dominate.mitchellcash.com", "testnet-seed.dominate.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for dominate, dominatefoundation, xpydev
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. dominate is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // dominate: mint proof-of-stake blocks in the background
